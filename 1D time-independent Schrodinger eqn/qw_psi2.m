...
m1 = load('qw_n0.dat');   % ground state
m2 = load('qw_n1.dat');   % 1st excited
m3 = load('qw_n2.dat');   % 2nd excited
m4 = load('qw_n3.dat');   % 3rd excited
% m5 = load('qw_n10.dat');  % example extra state

x1 = m1(:,1); psi1 = m1(:,5); V1 = m1(:,2);
x2 = m2(:,1); psi2 = m2(:,5); V2 = m2(:,2);
x3 = m3(:,1); psi3 = m3(:,5); V3 = m3(:,2);
x4 = m4(:,1); psi4 = m4(:,5); V4 = m4(:,2);
...
ylabel('|\psi(x)|^2','FontSize',20,'FontWeight','bold');
...
set(ax, ...
    ...
    'Layer','top', ...          % draw ticks/box above plotted lines
    'FontSize',16);
...
% Save
print(gcf,'qw_psi2_boxed','-dpng','-r300');
